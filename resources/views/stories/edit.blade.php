            ...
            <table class="bar w-full bg-white my-3">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="characters[{{ $character->name }}]" value="{{ $character->id }}" @if(old('characters[{{ $character->name}}]', true) === $story->isAppendCharacter($character)) checked @endif>{{ $character->name }}
                        @endforeach
                    </td>
                </tr>
            </table>
