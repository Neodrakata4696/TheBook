    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <table class="bar w-full bg-white my-3">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="selected_image_path" id="selected_image_path" class="w-full max-w-[90%] px-0" value="{{ old('selected_image_path') ?? $chara->image }}" readonly>
        ...
        <x-modal-museum name="image-uploader">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <input type="text" name="selected-image-flag" id="selected_image_flag" class="border-none w-full" value="{{ old('selected-image-flag') ?? $chara->image }}" readonly>
                <div id="gallery">
